...
android {
    namespace = "com.evasisstani.ev_asistani"
    ...
    defaultConfig {
        ...
        applicationId = "com.evasisstani.ev_asistani"
    ...
    signingConfigs {
        create("release") {
            if (keystorePropertiesFile.exists()) {
                ...
                // CI/CD veya test ortamları için (key.properties yoksa) debug imzasını fallback olarak kullan
